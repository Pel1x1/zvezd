...
import restaurant1 from "@/app/img/weddings/weddings.webp";
export const Hero = () => {
  ...
  return (
    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center z-1">
      ...
      <p className="text-white text-[30px] md:text-[70px] mb-4 drop-shadow-lg" style={{fontFamily: "ZenAntoquie"}}>ВЫЕЗДНЫЕ ЦЕРЕМОНИИ</p>
      <p className="text-white text-[15px] md:text-[30px] font-light max-w-2xl text-center drop-shadow-md"  style={{fontFamily: "RobotoL"}}>
На территории загородного комплекса вы сможете провести красивую незабываемую церемонию регистрации брака.</p>
      </div>
    </div>        
      {isMobile?(
