...
import  accommodation1 from "@/app/img/clubvil/ul_2.webp";
...
export const Hero = () => {
  ...
  <div className="relative mx-auto my-auto" style={{ width: isMobile ? "100%" : "97%", height: isMobile ? "50vh" : "95vh" }}>
    <Image
      ...
      placeholder="blur"
    />
    {/* Вот этот overlay затемнит фото */}
    <div
    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center z-10 mb-[120px] md:mb-[0px]">
      <div className="items-center flex flex-col justify-center">
        ...
        <p
          className="text-white text-[15px] md:text-[30px] font-light max-w-4xl text-center drop-shadow-md"
          style={{ fontFamily: "RobotoL" }}
        >
          Высокий уровень загородной жизни с первого дня
        </p>
      </div>
    </div>
  </div>
