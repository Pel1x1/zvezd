...
import  accommodation1 from "@/app/img/clubvil/ul_1_Final.jpg";
    ...
    <section className="relative w-full bg-black overflow-hidden" style={{height:isMobile?"":"100vh"}}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center z-1 ">
        <div className="items-center flex flex-col justify-center">
          <p className="text-white text-[30px] md:text-[70px] mb-4 drop-shadow-lg" style={{fontFamily: "ZenAntoquie"}}>КЛУБНЫЙ ПОСЁЛОК</p>
