...
export const Shalle = () => {
  ...
  return (
    <section className="self-center w-full max-w-full mt-[10px] bg-[rgba(210,182,177,1)]">
          <div className="relative inline-block bg-[rgba(210,182,177,1)] ">
            ...
            style={{
              ...
              <Link className="footer-link transition-colors" href={`/rooms/shalle`}>Подробнее</Link>
            </button>
          </div>
        </section>
  );
