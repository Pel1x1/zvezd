...
в загородном комплексе <span style={{ fontFamily: "Roboto" }}>«Звёздный»</span> – идеальном месте для отдыха, праздников и встреч с близкими. 
Наш отель предлагает стильные номера, где каждая деталь продумана для вашего отдыха. В ресторане вас ждут блюда европейской кухни, приготовленные с особым вниманием к вкусу и подаче.  
              </p>
            </div>
          </div>
        </CardContent>
        ...
        <CardContent className="p-7 flex flex-col justify-center" style={{marginTop: isMobile? "-10%" : ""}}>
          <div className="flex flex-col justify-center text-black max-md:mt-10 max-md:max-w-full">
            ...
            <div className="text-[15px] md:text-[23px] mt-8 font-light leading-8 tracking-[2px] text-black/80" style={{ fontFamily: "RobotoL" }}>
              <p  >
<span style={{ fontFamily: "Roboto" }}>Для мероприятий</span> – просторные банкетные залы, оборудованные для проведения свадеб, корпоративных и торжественных мероприятий. 
После праздника можно продолжить вечер за бильярдом или караоке, а для полного релакса – баня/хаммам и спа услуги. На свежем воздухе вас ждут уютные беседки, костровая зона и детская площадка. 
Любители активного отдыха оценят рыбалку, спортивную площадку и конные прогулки с возможностью фотосессий на фоне живописной природы.  
