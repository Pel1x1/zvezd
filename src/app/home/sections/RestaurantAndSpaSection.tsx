...
export const RestaurantAndSpaSection = () => {
  ...
  return (
    <section className="bg-[rgba(210,182,177,1)] w-full px-[70px] max-md:max-w-full max-md:px-5">
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
        <div className="w-6/12 max-md:w-full max-md:ml-0">
          <div
            className="flex flex-col relative min-h-[586px] text-[rgba(210,182,177,1)] font-light 
              pl-6 pr-12 pt-44 pb-[277px]
              max-md:max-w-full max-md:mt-10 max-md:px-5 max-md:py-[151px] max-md:items-center max-md:text-center max-md:mx-auto"
          >
            <Image
        ...
        <div className="w-6/12 ml-5 max-md:w-full max-md:ml-0">
          <div
            className="flex flex-col relative min-h-[580px] text-[rgba(210,182,177,1)] font-light leading-none mt-[164px]
              pl-[17px] pr-[52px] pt-[113px] pb-[306px]
              max-md:max-w-full max-md:mt-10 max-md:px-5 max-md:py-[151px] max-md:items-center max-md:text-center max-md:mx-auto"
          >
            <Image
