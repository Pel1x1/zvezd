    ...
    <section className="bg-[rgba(210,182,177,1)] w-full px-[70px] py-[71px] max-md:max-w-full max-md:px-5 mt-[50px]">
      <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
        <div className="w-6/12 max-md:w-full max-md:ml-0">
          <div className="flex flex-col relative min-h-[586px] text-[rgba(210,182,177,1)] font-light pl-6 pr-12 pt-44 pb-[277px] max-md:max-w-full max-md:mt-10 max-md:px-5 max-md:py-[100px] max-md:items-center max-md:text-center">
            <Image
              ...
              fill
            />
            <h2 className="relative text-[40px] font-medium leading-none uppercase">
              Ресторан
            </h2>
            ...
            {isMobile ? (
              <Button
              variant="primary"
              className="relative text-lg leading-none tracking-[2px] mt-4 w-fit text-white border-white
        ...
        <div className="w-6/12 ml-5 max-md:w-full max-md:ml-0">
          <div className="flex flex-col relative min-h-[580px] text-[rgba(210,182,177,1)] font-light leading-none mt-[164px] pl-[17px] pr-[52px] pt-[113px] pb-[306px] max-md:max-w-full max-md:mt-10 max-md:pr-5 max-md:py-[100px] max-md:items-center max-md:text-center">
            <Image
              ...
              fill
            />
            <h2 className="relative text-[40px] font-medium uppercase">СПА</h2>
            <p className="relative text-[20px] leading-5 tracking-[2px] self-stretch mt-5 max-md:max-w-full">
